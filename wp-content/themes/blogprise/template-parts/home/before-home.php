...
if ( is_active_sidebar( 'above-homepage-widget-area' ) ) :
	...
	$widget_style  = ' uf-wa-widget-' . get_theme_mod( 'above_home_widgets_style', 'style_1' );
	$heading_style = ' saga-title-style-' . get_theme_mod( 'above_home_widgetarea_heading_style', 'style_1' );
	...
	?>
	<div class="before-home-widget-region general-widget-area <?php echo esc_attr( $class ); ?>" role="complementary">
