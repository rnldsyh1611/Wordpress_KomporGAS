...
class Blogprise_Single_Column_Posts extends Blogprise_Widget_Base {
	/**
	 * Constructor.
	 */
	public function __construct() {

		$this->widget_cssclass    = 'blogprise_single_column_posts_widget';
		$this->widget_description = __( 'Displays posts in single column style', 'blogprise' );
		$this->widget_id          = 'blogprise_single_column_posts';
		$this->widget_name        = __( 'Blogprise: Single Column Posts', 'blogprise' );
		$this->settings           = array(
			'title'                     => array(
				'type'  => 'text',
	...
	public function get_posts( $args, $instance ) {
		...
		return new WP_Query( apply_filters( 'blogprise_single_column_posts_query_args', $query_args ) );
	}
	...
	public function widget( $args, $instance ) {
		...
		if ( ( $posts = $this->get_posts( $args, $instance ) ) && $posts->have_posts() ) {
			...
			do_action( 'blogprise_before_single_column_posts' );
			...
			<div class="blogprise-single-col-posts-widget <?php echo esc_attr( $widget_class ); ?>">
			...
			do_action( 'blogprise_after_single_column_posts' );
	...
	public function enqueue_assets() {
		if ( is_active_widget( false, false, $this->id_base ) ) {
			...
			$css_file    = get_template_directory() . '/inc/widgets/css/single-column-posts' . $file_prefix . '.css';
