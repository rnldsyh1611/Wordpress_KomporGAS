...
//	// Add Hire Developer Section - DISABLED
//	$wp_customize->add_section(
//		new alante_thinkup_customizer_customswitch_button_link(
//			$wp_customize,
//			$prefix_name . 'thinkup_customizer_section_hire',
//			array(
//				'title'        => __( 'Need help?', 'alante' ),
//				'priority'     => 1,
//				'button_text'  => __( 'Hire a Developer', 'alante' ),
	...
	$wp_customize->add_control(
		new alante_thinkup_customizer_customcontrol_upgrade_inner(
			...
			array(
				...
				'price_discount'  => __( 'Upgrade Now (10% off)', 'alante' ),
				'price_normal'	  => __( 'Use coupon at checkout for 10% off.', 'alante' ),
				'coupon'	      => __( 'thinkup10', 'alante' ),
