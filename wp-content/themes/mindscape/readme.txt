...
= How can I customize Mindscape? =

    To customize the Mindscape theme you have to open the Customizer by accessing the Appearance menu -> Customizer.

== License ==

Mindscape WordPress theme, Copyright (C) 2021 ExtendThemes
Mindscape WordPress theme is licensed under the GPL3.
