...
<div class="wp-block wp-block-kubio-dropdown-menu  position-relative wp-block-kubio-dropdown-menu__outer mindscape-front-header__k__c6BbujDIAOY-outer mindscape-local-710-outer kubio-dropdown-menu h-ignore-global-body-typography <?php echo $component->printHeaderMenuClasses(); ?>" data-kubio="kubio/dropdown-menu" data-kubio-component="dropdown-menu" data-kubio-settings="[]">
	...
	<div class="wp-block wp-block-kubio-menu-offscreen  position-relative wp-block-kubio-menu-offscreen__container mindscape-front-header__k__r1Ph182_RWJ-container mindscape-local-712-container" data-kubio="kubio/menu-offscreen">
		<div class="position-relative wp-block-kubio-menu-offscreen__align mindscape-front-header__k__r1Ph182_RWJ-align mindscape-local-712-align">
			<button class="position-relative wp-block-kubio-menu-offscreen__iconWrapper mindscape-front-header__k__r1Ph182_RWJ-iconWrapper mindscape-local-712-iconWrapper kubio-offscreen-icon-wrapper" data-target="#kubio-offscreen-6514289aed2ea" data-target-id="kubio-offscreen-6514289aed2ea" data-direction="right" data-width="300px" data-offcanvas-overlay-id="kubio-offscreen-6514289aed2ea-overlay" aria-label="<?php esc_attr_e( 'Mobile Menu', 'mindscape' );?>" data-kubio-component="offcanvas" data-kubio-settings="[]">
  ...
  'wrapper_class' => 'wp-block wp-block-kubio-logo position-relative wp-block-kubio-logo__container  kubio-logo-direction-row mindscape-front-header__k__afIZ7lcsb-container mindscape-local--container',
  'logo_image_class' => 'position-relative wp-block-kubio-logo__image  kubio-logo-image  mindscape-front-header__k__afIZ7lcsb-image mindscape-local--image',
  'alt_logo_image_class' => 'position-relative wp-block-kubio-logo__alternateImage kubio-logo-image kubio-alternate-logo-image   mindscape-front-header__k__afIZ7lcsb-alternateImage mindscape-local--alternateImage',
  'logo_text_class' => 'position-relative wp-block-kubio-logo__text  mindscape-front-header__k__afIZ7lcsb-text mindscape-local--text',
)); ?>
										</div>
									</div>
								</div>
