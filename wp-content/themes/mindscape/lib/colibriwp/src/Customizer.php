            ...
            Hooks::prefixed_apply_filters(
                ...
                array(
                    ...
                    'builderStatusData'         => array(
                        'status'       => mindscape_theme()->getPluginsManager()->getPluginState( mindscape_get_builder_plugin_slug() ),
                        'install_url'  => mindscape_theme()->getPluginsManager()->getInstallLink( mindscape_get_builder_plugin_slug() ),
                        'activate_url' => mindscape_theme()->getPluginsManager()->getActivationLink( mindscape_get_builder_plugin_slug() ),
                        'slug'         => mindscape_get_builder_plugin_slug(),
                        'messages'     => array(
